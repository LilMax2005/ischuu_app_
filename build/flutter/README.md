...
* `ischuu_app` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `ischuu_app_` - executable or bundle name on disk.
* `ischuu_app_` - display name shown in window titles and about app dialogs.
